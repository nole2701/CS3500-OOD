...
public class PyramidSolitaireTextualViewTest {
  ...
  public void testToStringStart() {
    initData();
    bps1.startGame(customDeck, false, 3, 2);
  ...
  public void testToStringGameOver() {
    initData();
    bps1.startGame(bps1.getDeck(), false, 3, 0);
    bpsView = new PyramidSolitaireTextualView(bps1);
    assertEquals(bpsView.toString(), "Game over. Score: 21");
  }
  ...
  public void testToStringWin() {
    ...
    modifyDeck(customDeck2);
    bps1.startGame(customDeck2, false,1,0);
