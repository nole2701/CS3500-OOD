...
public class BasicPyramidSolitaire implements PyramidSolitaireModel<Card> {
  ...
  private final ArrayList<ArrayList<Card>> pyramid;
  ...
  /**
   * Getter for gameStarted. Needed for testing.
  ...
  /**
   * getter for pyramid. Needed for testing.
   * @return returns the pyramid.
   */
  public ArrayList<ArrayList<Card>> getPyramid() {
    return pyramid;
  }

  /**
   * getter for stock pile. Needed for testing.
   * @return returns the stock pile.
   */
  ...
  /**
   * Variation of startGame() that allows invalid decks. Used for testing purposes.
   * @param deck Deck to be used.
   * @param shuffle To be shuffled or not.
   * @param numRows Number of rows.
   * @param numDraw Number of cards in draw hand.
   * @throws IllegalArgumentException Same as standard, but ignores invalid decks.
   */
  public void startGameAllowInvalid(List<Card> deck, boolean shuffle, int numRows, int numDraw)
      throws IllegalArgumentException {
   ...
   */
  public ArrayList<ArrayList<Card>> buildPyramid(List<Card> deck, int numRows) throws
   ...
   */
  private boolean checkDeck(List<Card> deck) throws IllegalArgumentException {
    if (deck == null) {
      throw new IllegalArgumentException("Deck is null");
    }
    boolean result = true;
   ...
   */
  private boolean checkNotEnoughCards(List<Card> deck, int numRows, int numDraw) throws
      IllegalArgumentException {
    if (deck == null) {
      throw new IllegalArgumentException("Deck is null");
    } else if (numRows < 1) {
   ...
   */
  private boolean canBeRemoved(int row, int card) throws IllegalArgumentException {
    boolean result = true;
  ...
  public int getScore() throws IllegalStateException {
    ...
    int result = 0;
    for (ArrayList<Card> cards : pyramid) {
      for (Card c : cards) {
        if (c != null) {
          result += c.getRank();
        }
